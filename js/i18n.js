...
const translations = {
  en: {
    ...
    aboutText1: "I am currently pursuing an <strong>Engineering Degree in Software Engineering</strong> at EMSI, Casablanca. My academic journey is focused on building a strong foundation in software architecture, data structures, and modern web technologies, with a strong interest in Artificial Intelligence.",
  ...
  fr: {
    ...
    aboutText1: "Je poursuis actuellement mon <strong>Diplôme d'Ingénieur en Génie Logiciel</strong> à l'EMSI Casablanca, avec un fort intérêt pour l'Intelligence Artificielle.",
  ...
  ar: {
    ...
    aboutText1: "أتابع حاليًا دراستي للحصول على <strong>شهادة هندسة في البرمجيات</strong> في EMSI بالدار البيضاء، مع اهتمام كبير بالذكاء الاصطناعي.",
