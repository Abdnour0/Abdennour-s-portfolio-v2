...
const translations = {
  en: {
    ...
    aboutText1: "I am currently pursuing an <strong>Engineering Degree in Software Engineering</strong> at <a href='https://emsi.ma/' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>EMSI</a>, Casablanca. My academic journey is focused on building a strong foundation in software architecture, data structures, and modern web technologies, with a strong interest in Artificial Intelligence.",
  ...
  fr: {
    ...
    aboutText1: "Je poursuis actuellement mon <strong>Diplôme d'Ingénieur en Génie Logiciel</strong> à l'<a href='https://emsi.ma/' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>EMSI</a> Casablanca, avec un fort intérêt pour l'Intelligence Artificielle.",
  ...
  ar: {
    ...
    aboutText1: "أتابع حاليًا دراستي للحصول على <strong>شهادة هندسة في البرمجيات</strong> في <a href='https://emsi.ma/' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>EMSI</a> بالدار البيضاء، مع اهتمام كبير بالذكاء الاصطناعي.",
